...
import BaiduOutlinedSvg from '@arvin-studio/icons-svg/es/asn/BaiduOutlined.js'
...
const BaiduOutlined = defineComponent<AsIconProps>(
  (props) => {
    return () => {
      return <AsIcon {...props} icon={BaiduOutlinedSvg} />
    }
  },
  {
    name: 'BaiduOutlined',
