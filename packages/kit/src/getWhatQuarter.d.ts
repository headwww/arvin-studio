 ...
 */
export declare function getWhatQuarter(date: string | Date | number | null | undefined, offset: number): Date;
 ...
 */
export declare function getWhatQuarter(date: string | Date | number | null | undefined, offset: number, day: number | 'first' | 'last'): Date;
