 ...
 */
export declare function mapTree<T, U, C = any>(array: T[] | undefined, iterate: (this: C, item: T, index: number, items: T[], path: string[], parent: T, nodes: T[]) => U, options?: MapTreeOptions, context?: C): U[];
