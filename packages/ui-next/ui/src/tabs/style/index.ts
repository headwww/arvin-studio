  ...
  return {
    [`${componentCls}-card`]: {
      [`> ${componentCls}-nav, > div > ${componentCls}-nav`]: {
        ...
        [`${componentCls}-tab-focus:has(${componentCls}-tab-btn:focus-visible)`]:
...
const genDropdownStyle: GenerateStyle<TabsToken, CSSObject> = (token) => {
  ...
  return {
    [`${componentCls}-dropdown`]: {
      ...
      [`&${asCls}-slide-down-enter${asCls}-slide-down-enter-active${componentCls}-dropdown-placement-bottomLeft,
        &${asCls}-slide-down-appear${asCls}-slide-down-appear-active${componentCls}-dropdown-placement-bottomLeft,
        &${asCls}-slide-down-enter${asCls}-slide-down-enter-active${componentCls}-dropdown-placement-bottom,
        &${asCls}-slide-down-appear${asCls}-slide-down-appear-active${componentCls}-dropdown-placement-bottom,
        &${asCls}-slide-down-enter${asCls}-slide-down-enter-active${componentCls}-dropdown-placement-bottomRight,
        &${asCls}-slide-down-appear${asCls}-slide-down-appear-active${componentCls}-dropdown-placement-bottomRight`]:
        {
          animationName: slideUpIn,
        },

      [`&${asCls}-slide-up-enter${asCls}-slide-up-enter-active${componentCls}-dropdown-placement-topLeft,
        &${asCls}-slide-up-appear${asCls}-slide-up-appear-active${componentCls}-dropdown-placement-topLeft,
        &${asCls}-slide-up-enter${asCls}-slide-up-enter-active${componentCls}-dropdown-placement-top,
        &${asCls}-slide-up-appear${asCls}-slide-up-appear-active${componentCls}-dropdown-placement-top,
        &${asCls}-slide-up-enter${asCls}-slide-up-enter-active${componentCls}-dropdown-placement-topRight,
        &${asCls}-slide-up-appear${asCls}-slide-up-appear-active${componentCls}-dropdown-placement-topRight`]:
        {
          animationName: slideDownIn,
        },

      [`&${asCls}-slide-down-leave${asCls}-slide-down-leave-active${componentCls}-dropdown-placement-bottomLeft,
        &${asCls}-slide-down-leave${asCls}-slide-down-leave-active${componentCls}-dropdown-placement-bottom,
        &${asCls}-slide-down-leave${asCls}-slide-down-leave-active${componentCls}-dropdown-placement-bottomRight`]:
        {
          animationName: slideUpOut,
        },

      [`&${asCls}-slide-up-leave${asCls}-slide-up-leave-active${componentCls}-dropdown-placement-topLeft,
        &${asCls}-slide-up-leave${asCls}-slide-up-leave-active${componentCls}-dropdown-placement-top,
        &${asCls}-slide-up-leave${asCls}-slide-up-leave-active${componentCls}-dropdown-placement-topRight`]:
        {
