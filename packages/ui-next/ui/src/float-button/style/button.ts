...
const genFloatButtonStyle: GenerateStyle<FloatButtonToken, CSSObject> = (
  token,
) => {
  const { componentCls, floatButtonSize, iconCls, asCls, floatButtonIconSize } =
    token;
