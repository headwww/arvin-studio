...
interface TransferInstance<RecordType = any> {
  $emit: {
    ...
    (
      event: 'selectChange',
      ...args: Parameters<TransferEmits['selectChange']>
    ): void;
    (event: 'search', ...args: Parameters<TransferEmits['search']>): void;
    (event: 'scroll', ...args: Parameters<TransferEmits['scroll']>): void;
    (
      event: 'update:targetKeys',
      ...args: Parameters<TransferEmits['update:targetKeys']>
    ): void;
    (
      event: 'update:selectedKeys',
      ...args: Parameters<TransferEmits['update:selectedKeys']>
    ): void;
  };
...
export interface TransferConstructor {
  new <RecordType = any>(
    props: InternalTransferProps<RecordType>,
  ): TransferInstance<RecordType>;
  /**
