      ...
      // ==========================================================
      {
        '&': {
          ...
          [itemCls]: {
            ...
            [varName('panel-active-bg-color')]: varRef(
              'item-icon-active-bg-color',
            ),
            [varName('panel-active-border-color')]: varRef(
              'item-icon-active-border-color',
            ),
            ...
            [varName('item-base-height')]: calc(varRef('panel-padding'))
              ...
              .equal(),
            [varName('item-base-width')]:
              `calc(${varRef('item-base-height')} * 0.7071)`,
