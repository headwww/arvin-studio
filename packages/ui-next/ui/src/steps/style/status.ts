    ...
    [componentCls]: [
      {
        ...
        [itemCls]: {
          ...
          [varName('item-icon-dot-border-color')]: varRef(
            'item-icon-dot-color',
          ),
          ...
          [varName('item-icon-border-hover-color')]: varRef(
            'item-icon-border-color',
          ),
          [varName('item-icon-text-hover-color')]: varRef(
          ...
          [varName('item-icon-active-border-color')]: varRef(
            'item-icon-border-color',
          ),
          [varName('item-icon-active-text-color')]: varRef(
            'item-icon-text-color',
          ),
