...
import { warning } from '@arvin-studio/headless';
...
export const FormHookRegistryKey: InjectionKey<FormHookRegistry> =
  Symbol('AFormHookRegistry');

export const FormInstanceContextKey: InjectionKey<FormInstance> =
  Symbol('AFormInstance');
