...
const genFormItemStyle: GenerateStyle<FormToken, CSSObject> = (token) => {
  ...
  const [varName] = genCssVar(asCls, 'grid');
...
const makeVerticalLayoutLabel: GenerateStyle<FormToken, CSSObject> = (
  token,
) => ({
...
const genHorizontalStyle: GenerateStyle<FormToken, CSSObject> = (token) => {
  ...
  return {
    [`${formItemCls}-horizontal`]: {
      ...
      [`${asCls}-col-24${formItemCls}-label,
        ${asCls}-col-xl-24${formItemCls}-label`]:
...
const genVerticalStyle: GenerateStyle<FormToken, CSSObject> = (token) => {
  const { componentCls, formItemCls, asCls, verticalLabelHeight } = token;
  ...
  return {
      ...
      makeVerticalLayout(token),
      {
        [componentCls]: {
          [`${formItemCls}:not(${formItemCls}-horizontal)`]: {
            [`${asCls}-col-xs-24${formItemCls}-label`]:
              makeVerticalLayoutLabel(token),
          },
        },
      },
    ...
    [`@media (max-width: ${unit(token.screenSMMax)})`]: {
      [componentCls]: {
        [`${formItemCls}:not(${formItemCls}-horizontal)`]: {
          [`${asCls}-col-sm-24${formItemCls}-label`]:
            makeVerticalLayoutLabel(token),
        },
      },
    },
    ...
    [`@media (max-width: ${unit(token.screenMDMax)})`]: {
      [componentCls]: {
        [`${formItemCls}:not(${formItemCls}-horizontal)`]: {
          [`${asCls}-col-md-24${formItemCls}-label`]:
            makeVerticalLayoutLabel(token),
        },
      },
    },
    ...
    [`@media (max-width: ${unit(token.screenLGMax)})`]: {
      [componentCls]: {
        [`${formItemCls}:not(${formItemCls}-horizontal)`]: {
          [`${asCls}-col-lg-24${formItemCls}-label`]:
            makeVerticalLayoutLabel(token),
        },
      },
    },
