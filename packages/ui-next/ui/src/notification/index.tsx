...
const GlobalHolder = defineComponent<{
  ...
  Object.keys(instance).forEach((method) => {
    (instance as any)[method as keyof NotificationInstance] = (
      ...args: any[]
    ) => {
      sync();
...
const methods: (keyof NoticeMethods)[] = [
  'success',
  'info',
  'warning',
  'error',
...
const staticMethods = baseStaticMethods as BaseMethods & NoticeMethods;
