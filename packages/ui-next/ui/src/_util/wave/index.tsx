...
>((props, { slots }) => {
  ...
  const waveClassName = computed(() => clsx(prefixCls.value, hashId.value));
  ...
  const attachListener = () => {
    ...
    node.addEventListener(eventName, handleEvent, { capture: true });
  ...
  watch(
    [
      containerRef,
      () => props.disabled,
      () => configCtx.value.wave?.triggerType,
    ],
    attachListener,
  );
  onBeforeUnmount(() => {
