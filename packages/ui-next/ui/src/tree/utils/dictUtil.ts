import type { DataNode, Key } from '@arvin-studio/headless';

import type { TreeProps } from '../Tree';

import { fillFieldNames } from '@arvin-studio/headless';

const RECORD_NONE = 0;
const RECORD_START = 1;
const RECORD_END = 2;

type Record = typeof RECORD_END | typeof RECORD_NONE | typeof RECORD_START;

type FieldNames = TreeProps['fieldNames'];

function traverseNodesKey(
  treeData: DataNode[],
  callback: (key: Key | null | number, node: DataNode) => boolean,
