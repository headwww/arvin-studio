...
export default function useModal(): readonly [
  instance: HookAPI,
  contextHolder: DefineComponent,
] {
  ...
  const getConfirmFunc = (
    ...
    function hookConfirm(config: ModalFuncProps) {
      ...
      let closePatch: undefined | VoidFunction;
      function closeFunc() {
        closePatch?.();
  ...
  const contextHolder = defineComponent(
    () => {
      return () => {
        return <ElementsHolder key="modal-holder" ref={holderRef as any} />;
      };
    },
    {
      name: 'ContextHolder',
