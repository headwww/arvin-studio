...
import type {
  ...
  DatePickerSlots,
  InternalPickerProps,
} from './generatePicker/generateSinglePicker';
import type { PickerPropsWithMultiple } from './generatePicker/interface';
...
export type { DatePickerEmits, DatePickerSlots };
