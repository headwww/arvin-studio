...
const genPickerStatusStyle: GenerateStyle<PickerToken, CSSObject> = (token) => {
  ...
  const [varName] = genCssVar(token.asCls, 'date-picker');
...
const genPickerStyle: GenerateStyle<PickerToken> = (token) => {
  ...
  const [varName, varRef] = genCssVar(asCls, 'date-picker');
  ...
  return [
    {
      [componentCls]: {
        ...
        '&-dropdown': {
          ...
          [`&${asCls}-slide-up-appear, &${asCls}-slide-up-enter`]: {
          ...
          [`&${asCls}-slide-up-enter${asCls}-slide-up-enter-active${componentCls}-dropdown-placement-bottomLeft,
          &${asCls}-slide-up-enter${asCls}-slide-up-enter-active${componentCls}-dropdown-placement-bottomRight,
          &${asCls}-slide-up-appear${asCls}-slide-up-appear-active${componentCls}-dropdown-placement-bottomLeft,
          &${asCls}-slide-up-appear${asCls}-slide-up-appear-active${componentCls}-dropdown-placement-bottomRight`]:
            {
          ...
          [`&${asCls}-slide-up-leave${asCls}-slide-up-leave-active${componentCls}-dropdown-placement-bottomLeft,
          &${asCls}-slide-up-leave${asCls}-slide-up-leave-active${componentCls}-dropdown-placement-bottomRight`]:
            {
