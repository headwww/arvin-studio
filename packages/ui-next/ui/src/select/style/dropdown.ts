...
const genSingleStyle: GenerateStyle<SelectToken> = (token) => {
  ...
  const slideUpEnterActive = `&${asCls}-slide-up-enter${asCls}-slide-up-enter-active`;
  const slideUpAppearActive = `&${asCls}-slide-up-appear${asCls}-slide-up-appear-active`;
  const slideUpLeaveActive = `&${asCls}-slide-up-leave${asCls}-slide-up-leave-active`;
