...
export const genImageCoverStyle: GenerateStyle<ImageToken, CSSObject> = (
  token,
) => {
...
export const genImagePreviewStyle: GenerateStyle<ImageToken, CSSObject> = (
  token,
) => {
  const {
    motionEaseOut,
...
export const prepareComponentToken: GetDefaultToken<'Image'> = (token) => ({
  ...
  previewOperationColor: new FastColor(token.colorTextLightSolid)
    .setA(0.65)
    .toRgbString(),
  previewOperationHoverColor: new FastColor(token.colorTextLightSolid)
    .setA(0.85)
    .toRgbString(),
  previewOperationColorDisabled: new FastColor(token.colorTextLightSolid)
    .setA(0.25)
    .toRgbString(),
