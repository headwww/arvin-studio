...
import { Pagination_by_By as Pagination } from '@arvin-studio/headless';
  ...
  Form: {
    ...
    defaultValidateMessages: {
      ...
      string: {
        ...
        range:
          'Значэнне поля «${label}» павінна мець даўжыню ${min}-${max} сімвалаў',
      },
      number: {
      ...
      array: {
        ...
        range:
          'Колькасць элементаў у полі «${label}» павінна быць паміж ${min} і ${max}',
      },
      pattern: {
