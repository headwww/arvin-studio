...
export function initComponentToken(
  ...
  const paddingBlock =
    Math.round(((controlHeight - mergedFontSize * lineHeight) / 2) * 10) / 10 -
    lineWidth;
  const paddingBlockSM =
    Math.round(((controlHeightSM - mergedFontSizeSM * lineHeight) / 2) * 10) /
      10 -
    lineWidth;
  const paddingBlockLG =
    Math.ceil(((controlHeightLG - mergedFontSizeLG * lineHeightLG) / 2) * 10) /
      10 -
    lineWidth;
