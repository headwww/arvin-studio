...
export const genActiveStyle: GenerateStyle<InputToken, CSSObject> = (
  token,
) => ({
...
export const genInputLargeStyle: GenerateStyle<InputToken, CSSObject> = (
  token,
) => {
...
export const genInputSmallStyle: GenerateStyle<InputToken, CSSObject> = (
  token,
) => ({
...
export function genBasicInputStyle(
  token: InputToken,
  option: {
...
export const genInputGroupStyle: GenerateStyle<InputToken, CSSObject> = (
  token,
) => {
  ...
  return {
    ...
    [`&-lg ${asCls}-select-single`]: {
      height: token.controlHeightLG,
    },

    [`&-sm ${asCls}-select-single`]: {
    ...
    [`${componentCls}-group`]: {
      ...
      '&-addon': {
        ...
        [`${asCls}-select`]: {
          ...
          [`&${asCls}-select-single:not(${asCls}-select-customize-input):not(${asCls}-pagination-size-changer)`]:
            {
        ...
        [`${asCls}-cascader-picker`]: {
          margin: `-9px ${unit(token.calc(token.paddingInline).mul(-1).equal())}`,
          backgroundColor: 'transparent',
          [`${asCls}-cascader-input`]: {
            textAlign: 'start',
            border: 0,
            boxShadow: 'none',
          },
    ...
    [`&${componentCls}-group-compact`]: {
      ...
      [`& > ${asCls}-select,
      & > ${asCls}-select-auto-complete ${componentCls},
      & > ${asCls}-cascader-picker ${componentCls},
      ...
      [`& > ${asCls}-select-focused`]: {
        zIndex: 1,
      },

      // update z-index for arrow icon
      [`& > ${asCls}-select > ${asCls}-select-arrow`]: {
        zIndex: 1,
      },

      [`& > *:first-child,
      & > ${asCls}-select:first-child,
      & > ${asCls}-select-auto-complete:first-child ${componentCls},
      & > ${asCls}-cascader-picker:first-child ${componentCls}`]: {
        borderStartStartRadius: token.borderRadius,
        borderEndStartRadius: token.borderRadius,
      },

      [`& > *:last-child,
      & > ${asCls}-select:last-child,
      & > ${asCls}-cascader-picker:last-child ${componentCls},
      & > ${asCls}-cascader-picker-focused:last-child ${componentCls}`]: {
        borderInlineEndWidth: token.lineWidth,
