...
function getArrowStyle<
  Token extends ArrowOffsetToken & ArrowToken & TokenWithCommonCls<AliasToken>,
>(
  token: Token,
  colorBg: string,
  options?: {
  ...
  return {
    [componentCls]: {
      ...
      [`${componentCls}-arrow`]: [
        {
          ...
          ...genRoundedArrow(
            token,
            colorBg,
            arrowShadow ? boxShadowPopoverArrow : false,
          ),
      ...
      ...isInject(!!arrowPlacement.top, {
        ...
        '&-placement-topRight': {
          [varName('arrow-offset-x')]:
            `calc(100% - ${unit(arrowOffsetHorizontal)})`,
